...
class RequestValidator implements IRequestValidator {
    ...
    public function isBodyValid($body, $operation, $resource) {
        if ($resource != "search") {
            if (!$this->isSetBodyAttributes($body, $operation, $resource) || !$this->isSetId($body, $operation))
                return false;
        }
    ...
    private function isSetBodyAttributes($body, $operation, $resource) {
